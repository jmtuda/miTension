...
- [x] **P0.1 Definir reglas pendientes:** rangos/avisos, acceso privado sin login cotidiano, zona horaria, CSV y formato/retención de OneDrive.
...
- [x] **P0.5 Proteger acceso:** Supabase Auth con cuenta única, propiedad por usuario, RLS y pruebas negativas; ninguna tabla clínica pública.

...
export function History({ measurements, filter, loading, error, deletingId, onFilterChange, onDelete, onExport, onRetry }: Props) {
  return (
    <section className="history" aria-labelledby="history-title" aria-busy={loading}>
      <div className="section-heading">
        ...
        <button className="button secondary export" type="button" onClick={onExport} disabled={loading || measurements.length === 0}>
